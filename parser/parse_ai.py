...
PDF_URL     = "https://api.itmo.su/constructor-ep/api/v1/static/programs/10033/plan/abit/pdf"
PDF_PATH    = "data/ai_curriculum.pdf"
PROGRAM_NAME = "ИИ"

def parse_ai_pdf_to_table() -> pd.DataFrame:
    ...
    save_to_csv(df_hier,   "data/ai_hierarchical.csv")
    save_to_parquet(df_hier,   "data/ai_hierarchical.parquet")
    return df_hier
